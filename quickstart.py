...
def plan_train_base_scratch_3b(root: Path) -> Plan:
    return Plan(
        ...
        description="Random-weight initialization from Qwen 3B config/tokenizer (16GB stable defaults).",
        commands=[
            p_cmd(
                root / "tiny-llm",
                "02_train_base.py",
...
def plan_train_base_scratch_3b_wiki(root: Path) -> Plan:
    return Plan(
        ...
        description="Random-weight initialization with tiny recipe plus streamed English Wikipedia (16GB stable defaults).",
        commands=[
            p_cmd(
                root / "tiny-llm",
                "02_train_base.py",
